...
var dnanrangeabs = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
...
tape( 'the function calculates the range of absolute values of a one-dimensional ndarray, ignoring NaN values', opts, function test( t ) {
	var x;
	var v;
...
tape( 'if provided an ndarray containing a single non-NaN element, the function returns `0`', opts, function test( t ) {
	var x;
	var v;
